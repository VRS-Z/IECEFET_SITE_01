...
O IECEFET foi fundado em 2021 e oferece cursos de supletivo, técnicos e de qualificação profissional, totalmente a distância e com diploma digital reconhecido pelo MEC. O site apresenta a instituição, seus diferenciais, cursos oferecidos e parcerias, com contato direto via WhatsApp para matrículas.
...
- JavaScript puro (menu mobile, scroll reveal, botão de voltar ao topo)
- [Font Awesome](https://fontawesome.com/) para ícones
- [Google Fonts — Plus Jakarta Sans](https://fonts.google.com/specimen/Plus+Jakarta+Sans) para tipografia
...
```bash
git clone https://github.com/VRS-Z/IECEFET_SITE_01.git
cd IECEFET_SITE_01
```
...
<sub>&copy; IECEFET — Iniciativa Educacional e Cultural para Formação e Trabalho.</sub>
